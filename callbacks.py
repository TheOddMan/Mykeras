...
class ModelCheckpoint(Callback):
    ...
    def myFunc(self,current,filepath,epoch,mon,batch):
        import sys
        sys.path.insert(0, 'D:\\Maimy\\CNN\\RandomSampling')
        import TrainModel1
        if (self.TorV == 'Training' and round(current,3) > TrainModel1.highestTrainingAcc):
            ...
            text_file = open('D:\\Maimy\\CNN\\RandomSampling\\HighestTraining.txt', 'w')
            ...
            text_file = open('D:\\Maimy\\CNN\\RandomSampling\\HighestValidation.txt', 'w')
